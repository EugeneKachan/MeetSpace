...
for the MVP version of **MeetSpace**, a web-based meeting room booking
system designed for organizations with multiple offices.

### 1.2 Scope

MeetSpace allows employees to: - Book meeting rooms in any office -
...
MeetSpace is a web-based client-server application.
